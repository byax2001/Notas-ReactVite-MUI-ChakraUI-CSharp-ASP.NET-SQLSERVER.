...
public partial class CalificacionesPContext : DbContext
{
    public CalificacionesPContext()
    {
    }

    public CalificacionesPContext(DbContextOptions<CalificacionesPContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=BRANDON\\SQLBYAXDB; Encrypt=False; DataBase=CalificacionesP;Trust Server Certificate=true;User Id=byax;Password=byax2001;MultipleActiveResultSets=true");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Alumno>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__alumno__3213E83FB741302E");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__asignatu__3213E83FEF19D6D0");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__califica__3213E83FE2DE36F3");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__matricul__3213E83FCBD9C6DD");
        ...
        {
            entity.HasKey(e => e.Usuario).HasName("PK__profesor__9AFF8FC7404CFCE8");
